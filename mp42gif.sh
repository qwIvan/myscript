...
mp42gif(){
  ...
  filters="fps=16,scale=1280:-1:flags=lanczos"
...
gifsicle --crop 400,0+0x-300 1.gif 2.gif 3.gif 4.gif 5.gif -O3 --lossy=80 -o optimized-yang.gif
...
gifsicle --crop 400,0+0x-300 6.gif 7.gif 8.gif 9.gif 10.gif -O3 --lossy=80 -o optimized-src.gif
